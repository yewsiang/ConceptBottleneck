...
def extract_data():
    cwd = os.getcwd()
    data_path = join(cwd,'datasets/CUB_200_2011/images')
    val_ratio = 0.2
    ...
    with open(join(cwd, 'datasets/CUB_200_2011/attributes/image_attribute_labels.txt'), 'r') as f:
        for line in f:
    ...
    with open(join(cwd, 'datasets/CUB_200_2011/train_test_split.txt'), 'r') as f:
        for line in f:
